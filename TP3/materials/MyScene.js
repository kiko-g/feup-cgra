...
class MyScene extends CGFscene
{
    ...
    initLights()
    {
        ...
        this.lights[0].setPosition(2.0, 2.0, -3.0, 1.0);
        ...
        this.lights[1].setPosition(-2.0, -1.0, -2.0, 1.0);
    ...
    initCameras()
    {
        this.camera = new CGFcamera(0.8, 0.1, 500, vec3.fromValues(10, 10, 10), vec3.fromValues(0, 0, 0));
    }
    ...
    initMaterials()
    {
        ...
        this.material4.setAmbient(0.4, 0.2, 0, 1.0);
        this.material4.setDiffuse(0.75, 0.5, 0.25, 1.0);
        this.material4.setSpecular(0.5, 0.2, 0.1, 1.0);
