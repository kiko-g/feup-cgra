...
class MyInterface extends CGFinterface
{
    ...
    init(application)
    {
        ...
        this.gui.add(this.scene, 'displayQuad').name('Quad');       //useless when cube is showing
        this.gui.add(this.scene, 'displayQuadCube').name('Quad Cube');
        this.gui.add(this.scene, 'displayTangram').name('Tangram');
        this.gui.add(this.scene, 'displayQuadMaterial').name('Quad Material'); //Uncheck for Minecraft skin, Check for dropdown skins 
